...
> `EasyAdmin8-Laravel` 在 [`EasyAdmin`](https://gitee.com/zhongshaofa/easyadmin) 的基础上使用 Laravel 12.x 重构，PHP 最低版本要求不低于 8.2
>
> 请注意：当前项目采用 `laravel 12.x` 构建，如需要 `laravel 10.x` 请在分支中选择 `10.x`
>
